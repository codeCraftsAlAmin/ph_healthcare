...
-- RenameIndex
ALTER INDEX "admin_email_idx" RENAME TO "idx_admin_email";

-- RenameIndex
ALTER INDEX "admin_isDeleted_idx" RENAME TO "idx_admin_isDeleted";

-- RenameIndex
ALTER INDEX "super_admin_email_idx" RENAME TO "idx_super_admin_email";

-- RenameIndex
ALTER INDEX "super_admin_isDeleted_idx" RENAME TO "idx_super_admin_isDeleted";
