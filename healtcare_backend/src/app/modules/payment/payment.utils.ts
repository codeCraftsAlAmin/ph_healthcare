  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .text(
          `Payment Date: ${new Date(payload.paymentDate).toLocaleDateString()}`,
        )
      ...
      doc.fontSize(10).font("Helvetica").text(`Name: ${payload.doctorName}`);
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          `Appointment Date: ${new Date(payload.appointmentDate).toLocaleDateString()}`,
        );
      ...
      doc.text(`${payload.amount.toFixed(2)} BDT`, col2X, amountY, {
        align: "right",
      });
      ...
      doc.text(`${payload.amount.toFixed(2)} BDT`, col2X, totalY, {
        align: "right",
      });
